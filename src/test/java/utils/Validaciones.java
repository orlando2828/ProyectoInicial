...
public class Validaciones {
    ...
    public static void validarObjeto(WebElement webElement, String descripcionElemento){
        ...
        try {
            ...
            PdfQaNovaReports.addWebReportImage("Validación elemento " + descripcionElemento, "se despliega correctamente el elemento" + descripcionElemento + "No se despliega elemento", EstadoPrueba.FAILED, false);
        }
